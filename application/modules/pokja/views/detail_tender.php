        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-sm table-borderless mb-0">
                    <tr><td width="150">Nama/Kode Tender</td><td>: <strong><?= $tender->kode_tender ?? ($tender->nama_tender ?? '') ?></strong></td></tr>
                    <tr><td>Sifat / Segmentasi</td><td>: <strong><?= $tender->segmentasi ?? '-' ?></strong></td></tr>
                    <tr><td>Jenis Pengadaan</td><td>: <?= $tender->jenis_tender ?? 'Konstruksi' ?></td></tr>
                </table>
            </div>
            <div class="col-md-6 border-left">
                <table class="table table-sm table-borderless mb-0">
                    ...
                    <tr><td>Nilai HPS</td><td>: <strong class="text-success">Rp <?= number_format($tender->hps ?? 0, 0, ',', '.') ?></strong></td></tr>
                </table>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs custom-tabs" id="detailTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="mt-tab" data-toggle="tab" href="#manajer_teknik" role="tab"><i class="fas fa-cogs mr-1"></i> Manajer Teknik</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content border border-top-0 bg-white p-4 shadow-sm rounded-bottom" id="detailTabContent">
            ...
            <div class="tab-pane fade show active" id="manajer_teknik" role="tabpanel">
            ...
            <div class="tab-pane fade" id="peralatan" role="tabpanel">
                <?php if(isset($tender->jenis_tender) && $tender->jenis_tender == 'Konsultansi'): ?>
                    <div class="text-center py-5">
